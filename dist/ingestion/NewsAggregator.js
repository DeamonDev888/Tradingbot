...
var TradingEconomicsScraper_1 = require("./TradingEconomicsScraper");
var pg_1 = require("pg");
...
var NewsAggregator = /** @class */ (function () {
    function NewsAggregator() {
        ...
        this.teScraper = new TradingEconomicsScraper_1.TradingEconomicsScraper();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.teScraper.scrapeUSCalendar()];
                    case 1:
                        events = _a.sent();
                        // Sauvegarder les événements bruts dans leur propre table
                        return [4 /*yield*/, this.teScraper.saveEvents(events)];
                    case 2:
                        // Sauvegarder les événements bruts dans leur propre table
                        _a.sent();
                        // Convertir en NewsItems pour le flux général
                        return [2 /*return*/, events.map(function (event) { return ({
                                title: "[ECO CALENDAR] ".concat(event.event, " (").concat(event.country, "): Actual ").concat(event.actual, " vs Forecast ").concat(event.forecast),
                                source: 'TradingEconomics',
                                url: 'https://tradingeconomics.com/united-states/calendar',
                                timestamp: event.date,
                                sentiment: 'neutral', // À analyser
                                content: "Importance: ".concat(event.importance, "/3. Previous: ").concat(event.previous),
                            }); })];
                    case 3:
                        error_6 = _a.sent();
                        console.error('Error fetching TradingEconomics calendar:', error_6);
                        return [2 /*return*/, []];
     ...
     */
    NewsAggregator.prototype.fetchAndSaveMarketData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var stockData, client, assetType, symbol, sourceInfo, error_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 9, , 10]);
                        console.log('📈 Fetching market data (ES Futures priority)...');
                        return [4 /*yield*/, this.finnhubClient.fetchSP500Data()];
                    case 1:
                        stockData = _a.sent();
                        if (!stockData) return [3 /*break*/, 7];
                    ...
                    case 4:
                        _a.sent();
                        sourceInfo = stockData.symbol.includes('ES_FUTURES')
                            ? ' (Futures directs)'
                            : stockData.symbol.includes('ES_FROM_SPY')
                                ...
                                : stockData.symbol.includes('ES_FROM_QQQ')
                                    ? ' (via QQQ)'
                                    : ' (ETF)';
                        console.log("\u2705 Market data saved for ".concat(symbol).concat(sourceInfo, ": ").concat(stockData.current.toFixed(2), " (").concat(stockData.change > 0 ? '+' : '').concat(stockData.percent_change.toFixed(2), "%)"));
                        return [3 /*break*/, 6];
                    case 5:
                        client.release();
                        return [7 /*endfinally*/];
                    ...
                    case 9:
                        error_7 = _a.sent();
                        console.error('❌ Error fetching/saving market data:', error_7);
                        return [3 /*break*/, 10];
    ...
    NewsAggregator.prototype.saveNewsToDatabase = function (news) {
        return __awaiter(this, void 0, void 0, function () {
            var client, savedCount, _i, news_4, item, e_1, error_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (news.length === 0)
                    ...
                    case 10:
                        error_8 = _a.sent();
                        console.error('❌ Database error saving news:', error_8);
                        return [3 /*break*/, 12];
                    case 11:
                        client.release();
                        return [7 /*endfinally*/];
    ...
    NewsAggregator.prototype.fetchAndSaveAllNews = function () {
        return __awaiter(this, void 0, void 0, function () {
            var allNews, _a, zerohedge, cnbc, financialjuice, finnhub, fred, te, error_9;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = _b.sent(), zerohedge = _a[0], cnbc = _a[1], financialjuice = _a[2], finnhub = _a[3], fred = _a[4], te = _a[5];
                        ...
                        if (fred.status === 'fulfilled') {
                            allNews.push.apply(allNews, fred.value);
                            console.log("\u2705 FRED: ".concat(fred.value.length, " indicators"));
                        }
                        if (te.status === 'fulfilled') {
                            allNews.push.apply(allNews, te.value);
                            console.log("\u2705 TradingEconomics: ".concat(te.value.length, " events"));
                        }
                    ...
                    case 4:
                        error_9 = _b.sent();
                        console.error('❌ Error during news aggregation:', error_9);
                        return [2 /*return*/, allNews];
