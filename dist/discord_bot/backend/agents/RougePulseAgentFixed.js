...
class RougePulseAgentFixed extends BaseAgentSimple_1.BaseAgentSimple {
    ...
    isKeyMarketIndicator(eventName) {
        const keyIndicators = [
            'fomc', 'fed', 'federal reserve', 'interest rate', 'taux directeur',
            'gdp', 'pib', 'inflation', 'cpi', 'ipc', 'ppi', 'emploi',
            'unemployment', 'nonfarm payrolls', 'nfp', 'chômage',
            'retail sales', 'ventes au détail', 'consumer confidence', 'confiance des consommateurs',
