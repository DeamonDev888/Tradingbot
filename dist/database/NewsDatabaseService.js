...
var NewsDatabaseService = /** @class */ (function () {
     ...
     */
    NewsDatabaseService.prototype.getEconomicEvents = function (startDate_1, endDate_1) {
        return __awaiter(this, arguments, void 0, function (startDate, endDate, minImportance) {
            var client, result, error_7;
            if (minImportance === void 0) { minImportance = 1; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.pool)
                    ...
                    case 4:
                        error_7 = _a.sent();
                        console.error('Error fetching economic events:', error_7);
                        return [2 /*return*/, []];
                    case 5:
                        client.release();
                        return [7 /*endfinally*/];
