...
export class DataMaintenanceService {
     ...
     */
    async markHistoricalPeriods(client) {
     ...
     */
    async archiveImportantData(client) {
     ...
     */
    async ensureArchiveTables(client) {
        await client.query(`
     ...
     */
    async calculateSpaceRecovered(client, table, rowsDeleted) {
        try {
            const result = await client.query(`
