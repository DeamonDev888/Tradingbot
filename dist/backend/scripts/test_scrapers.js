...
async function testScrapers() {
    ...
    for (const test of newsTests) {
        try {
            ...
            console.error(`❌ Erreur ${test.name}:`, error instanceof Error ? error.message : String(error));
        }
    }
    ...
    console.log(`   • Si VIX scraper échoue, les sites utilisent probablement une protection anti-bot`);
