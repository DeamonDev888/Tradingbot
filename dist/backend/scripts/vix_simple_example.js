...
async function getVIXSimple() {
    ...
    return new Promise((resolve, reject) => {
        ...
        client.on('authenticationError', (error) => {
            clearTimeout(timeoutId);
            client.disconnect();
 ...
 */
async function getCurrentVIXPrice() {
    try {
        const vixData = (await getVIXSimple());
...
//# sourceMappingURL=vix_simple_example.js.map