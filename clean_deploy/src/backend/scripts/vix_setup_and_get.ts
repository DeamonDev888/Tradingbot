...
export class VIXSetupAndGetter {
  private sierraPath: string = 'C:/SierraChart';
  private dataPath: string = 'C:/SierraChart/Data/';
   ...
   */
  async launchSierraChartWithVIX(): Promise<boolean> {
   ...
   */
  async setupAndGetVIX(): Promise<void> {
